...
[![Deploy](https://www.herokucdn.com/deploy/button.svg)](https://heroku.com/deploy?template=https://github.com/wariastore/bot-saya)
...
git clone https://github.com/saipulanuar/bot-aq
cd wabot-aq
npm install
npm update
```
